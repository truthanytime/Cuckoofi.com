package com.cuckoofi.pricelineservice.model.expressresults.request;
...
@Data
public class ExpressResultsRequest implements Serializable {
    ...
    @Schema(description = "integer, Example: rate_limit=2, Number passed to limit the number of rates returned. Defaults to returning all available rates")
    Integer rate_limit;
